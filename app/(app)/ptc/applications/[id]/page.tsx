...
import { EditApplicationButton } from "@/components/ptc/edit-application-button";
  ...
  return (
    <div className="grid">
      <div className="topbar">
        <Link className="button secondary" href={`/ptc/applications?version=${recordVersionParam}`}>Back to Applications</Link>
        <EditApplicationButton
          record={{
            ...
            returnTo: `/ptc/applications/${record.id}`,
            ...
            recommendingApprovalSignatureStatus: record.recommendingApprovalSignatureStatus || null,
            recommendingApprovalSignatureForName: record.recommendingApprovalSignatureForName || "",
            approved: record.approved || "",
            approvedSignatureStatus: record.approvedSignatureStatus || null,
      ...
      <section className="panel">
        ...
        <div className="metadata-grid">
          ...
          <div><span>Recommending Approval Signature</span><strong>{signatureStatusLabel(record.recommendingApprovalSignatureStatus)}</strong></div>
          <div><span>Recommending Approval Signature For</span><strong>{metadataValue(record.recommendingApprovalSignatureForName || "")}</strong></div>
          <div><span>Approved</span><strong>{metadataValue(record.approved || "")}</strong></div>
          <div><span>Approved Signature</span><strong>{signatureStatusLabel(record.approvedSignatureStatus)}</strong></div>
          <div><span>Approved Signature For</span><strong>{metadataValue(record.approvedSignatureForName || "")}</strong></div>
        </div>
      </section>
