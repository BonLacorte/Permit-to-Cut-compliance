...
function coverageParams({
  ...
  return `/ptc-report/document-coverage?${params.toString()}`;
}
    ...
    <div className="grid">
      <div className="topbar">
        ...
        <VersionFilter
          ...
          path="/ptc-report/document-coverage"
          preservedParams={{
      ...
      <form className="panel form" action="/ptc-report/document-coverage">
        ...
        <div className="actions"><button className="button" type="submit">Apply Filters</button><Link className="button secondary" href={`/ptc-report/document-coverage?version=${encodeURIComponent(versionContext.selectedVersionParam)}`}>Clear Filters</Link></div>
      </form>
          ...
          <tbody>
            {detailRows.map((audit) => {
              ...
              return <tr key={audit.id}>
                ...
                <td><Link className="button secondary" href={`/ptc/applications/${audit.id}`}>View</Link></td>
              </tr>;
            })}
