...
export function applicationExportRows(audits: RecordAudit[]) {
  return audits.map((audit) => ({
    ...
    "Recommending Approval Signature": signatureStatusLabel(audit.recommendingApprovalSignatureStatus),
    "Recommending Approval Signature For": audit.recommendingApprovalSignatureForName || "",
    Approved: audit.approved || "",
    "Approved Signature": signatureStatusLabel(audit.approvedSignatureStatus),
