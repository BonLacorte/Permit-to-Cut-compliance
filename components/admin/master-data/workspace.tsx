...
import { ImportCheckerPanel } from "@/components/admin/import-checker-panel";
    ...
    <div className="grid">
      ...
      <section className="panel table-wrap">
        ...
        <form action={createPttTransportTypeAction} className="inline-edit-form">
          ...
          <NumericInput name="maxBoardFeet" min="0" step="0.01" placeholder="Custom max bd. ft." />
        ...
        <table>
          ...
          {returnField(returnToPtt)}
                    ...
                    <NumericInput name="maxBoardFeet" min="0" step="0.01" defaultValue={type.maxBoardFeet === null ? "" : String(type.maxBoardFeet)} placeholder="Custom max bd. ft." aria-label="Custom max board feet" />
                    <SubmitButton className="button secondary" pendingText="Saving...">Save</SubmitButton>
                  </form>
                </td>
